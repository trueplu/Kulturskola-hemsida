...
export const meta = {
    title: 'Baryton - Uppvärmning och enkel flex',
    // description:
...
[Övning: Uppvärmning och enkel flex](https://drive.google.com/file/d/1NMchzaQOU6xGUl9C6sj93h-IAvCtTGSA/view?usp=sharing)
