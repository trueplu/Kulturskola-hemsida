...
export const meta = {
    title: 'Valthorn - Uppvärmning och enkel flex',
    // description:
...
Det står legatobågar inskrivna. Tänk på att inte bryta luftströmmen innan du kommit till slutet på bågen.

[Övning: Uppvärmning och enkel flex](https://drive.google.com/file/d/1T5lGFPZRqog9EMitHTg1m4gQTJGfZrIR/view?usp=sharing)

<YouTubeEmbed videoID="PYu_5R50v3s" />
